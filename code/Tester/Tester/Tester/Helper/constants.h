...
const char* UNDEFINED_STRUCTURE     = "CURRENT_STRUCTURE_UNDEFINED";
const char* UNDEFINED_PREVIOUS      = "PREVIOUS_STRUCTURE_UNDEFINED";

const char* INTERNAL_ERROR_OCCURED  = "AN INTERNAL ERROR HAS OCCURED";
...
const char* VECTOR_GO_TO            = "VectorGoTo";
const char* VECTOR_LENGHT           = "VectorLength";
const char* VECTOR_REMOVE_POSITION  = "VectorRemovePosition";
const char* VECTOR_REMOVE_VALUE     = "VectorRemoveValue";
const char* VECTOR_SEARCH           = "VectorSearch";
const char* VECTOR_PRINT            = "VectorPrint";

const char* LIST_GO_TO              = "ListGoTo";
const char* LIST_ADD                = "ListAdd";
const char* LIST_READ               = "ListRead";
const char* LIST_PRINT              = "ListPrint";
const char* LIST_MERGE              = "ListMerge";
const char* LIST_SORT               = "ListSort";
